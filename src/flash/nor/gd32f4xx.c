...
#define GD32F4XX_OTP_SIZE 			512
#define GD32F4XX_OTP_SECTOR_SIZE 	32
#define GD32F4XX_OTP_BANK_BASE      0x1fff7800
#define GD32F4XX_OTP_LOCK_BASE      ((GD32F4XX_OTP_BANK_BASE) + (GD32F4XX_OTP_SIZE))
...
static const struct command_registration stm32x_command_handlers[] = {
	{
		.name = "gd32f4xx",
		.mode = COMMAND_ANY,
		.help = "gd32f4xx flash command group",
		.usage = "",
...
const struct flash_driver gd32f4xx_flash= {
	.name = "gd32f4xx",
